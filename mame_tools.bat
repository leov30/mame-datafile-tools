...
if not exist "%_xidel%.exe" echo This script needs %_xidel%.exe to work&pause&exit
...
%_xidel% -s _temp\temp.dat -e "//%_tag%[year and manufacturer and not(@cloneof) and not(@isdevice) and not(@isbios)]/(@name|description|year|manufacturer)" >_temp\temp.1
%_xidel% -s _temp\temp.1 -e "replace( $raw, '^(\w+)\r\n(.+?)\r\n(.+?)\r\n(.+)$', '$1	$2	$3	$4', 'm')" >_temp\temp.2
REM %_xidel% -s _temp\temp.dat -e "//%_tag%[@cloneof and not(@isdevice) and not(@isbios)]/(@name|@cloneof|description)" >_temp\temp.1
REM %_xidel% -s _temp\temp.1 -e "replace( $raw, '^(\w+)\r\n(\w+)\r\n(.+)$', '$2[c]	$1	$3', 'm')" >>_temp\temp.2
sort _temp\temp.2 /o _temp\temp.1
%_xidel% -s _temp\temp.1 -e "replace( $raw, '^(\w+)\t(.+?)\t(.+?)\t(.+)$', '<p>$2 [$1] * $4 | $3</p>', 'm')" >>_temp\main.html
...
%_xidel% -s _temp\temp.dat -e "//%_tag%/input/@control" >_temp\index.1
call :nodups index.1 1
type nul>_temp\temp.2
for /f %%g in (_temp\index.1) do (
	%_xidel% -s _temp\temp.dat -e "//%_tag%/input[@control='%%g']/../(@name|description)" >_temp\temp.1
	%_xidel% -s _temp\temp.1 -e "replace( $raw, '^(\w+)\r\n(.+)$', '%%g	$1|$2', 'm')" >>_temp\temp.2
...
:list_nodump
%_xidel% -s _temp\temp.dat -e "//%_tag%/rom[not(@status='baddump') and @status='nodump']/../(@name|description)" >_temp\temp.1
%_xidel% -s _temp\temp.1 -e "replace( $raw, '^(\w+)\r\n(.+)$', 'nodump	$1|$2', 'm')" >_temp\temp.2

%_xidel% -s _temp\temp.dat -e "//%_tag%/rom[@status='baddump' and not(@status='nodump')]/../(@name|description)" >_temp\temp.1
%_xidel% -s _temp\temp.1 -e "replace( $raw, '^(\w+)\r\n(.+)$', 'baddump	$1|$2', 'm')" >>_temp\temp.2

%_xidel% -s _temp\temp.dat -e "//%_tag%/rom[@status='baddump' and @status='nodump']/../(@name|description)" >_temp\temp.1
...
%_xidel% -s _temp\temp.dat -e "//%_tag%[sample and not(@sampleof)]/(@name|description)" >_temp\temp.1
%_xidel% -s _temp\temp.1 -e "replace( $raw, '^(\w+)\r\n(.+)$', '$1[s]	$1|$2', 'm')" >_temp\temp.2
REM //all games that need samples
%_xidel% -s _temp\temp.dat -e "//%_tag%[@sampleof]/(@name|@sampleof|description)" >_temp\temp.1
%_xidel% -s _temp\temp.1 -e "replace( $raw, '^(\w+)\r\n(\w+)\r\n(.+)$', '$2	$1|$3', 'm')" >>_temp\temp.2
...
if %_drv_old%==true (
%_xidel% -s _temp\temp.dat -e "//%_tag%[not(@cloneof)]/driver[@status='preliminary' or @status='protection' or @graphic='preliminary' or @color='preliminary' or @sound='preliminary']/../(@name|description)" >_temp\temp.1
%_xidel% -s _temp\temp.dat -e "//%_tag%[@cloneof]/driver[@status='good' and @color='good' and @sound='good' and @graphic='good']/../(@name|@cloneof|description)" >_temp\temp.2

)else (
%_xidel% -s _temp\temp.dat -e "//%_tag%[not(@cloneof)]/driver[%_option2%@status='preliminary']/../(@name|description)" >_temp\temp.1
%_xidel% -s _temp\temp.dat -e "//%_tag%[@cloneof]/driver[%_option%@status='good']/../(@name|@cloneof|description)" >_temp\temp.2

)

%_xidel% -s _temp\temp.1 -e "replace( $raw, '^(\w+)\r\n(.+)$', '$1[p]	$1	$2', 'm')" >_temp\parents.lst
%_xidel% -s _temp\temp.2 -e "replace( $raw, '^(\w+)\r\n(\w+)\r\n(.+)$', '$2	$1	$3', 'm')" >_temp\clones.lst

type nul>_temp\xclones.lst
for /f "delims=[" %%g in (_temp\parents.lst) do (
	for /f "delims=" %%h in ('%_xidel% -s _temp\clones.lst -e "matches( $raw, '^%%g\t', 'm')"') do (
		if %%h==true (
			%_xidel% -s _temp\clones.lst -e "extract( $raw, '^%%g\t.+$', 0,'m*')" >>_temp\xclones.lst
			%_xidel% -s _temp\parents.lst -e "extract( $raw, '^%%g\[p\]\t.+$', 0,'m*')" >>_temp\xclones.lst
		)
...
%_xidel% -s _temp\temp.dat -e "//%_tag%[manufacturer]/(@name|description|manufacturer)" >_temp\temp.1
%_xidel% -s _temp\temp.1 -e "replace( $raw, '^(\w+)\r\n(.+?)\r\n(.+)$', '$3	$1	$2', 'm')" >_temp\temp.2
sort _temp\temp.2 /o output\manufacturer.txt

%_xidel% -s _temp\temp.dat -e "//%_tag%[year]/(@name|description|year)" >_temp\temp.1
%_xidel% -s _temp\temp.1 -e "replace( $raw, '^(\w+)\r\n(.+?)\r\n(.+)$', '$3	$1	$2', 'm')" >_temp\temp.2
...
%_xidel% -s _temp\temp.dat -e "//%_tag%[@ismechanical='yes']/(@name|description)" >_temp\temp.1
%_xidel% -s _temp\temp.dat -e "//%_tag%[@isdevice='yes']/(@name|description)" >_temp\temp.2
...
%_xidel% -s _temp\temp.dat -e "//%_tag%[@romof]/(@name|@romof|description)" >_temp\temp.1
%_xidel% -s _temp\temp.1 -e "replace( $raw, '^(\w+)\r\n(\w+)\r\n(.+)$', '$2	$1	$3', 'm')" >_temp\temp.2

%_xidel% -s _temp\temp.dat -e "//%_tag%[%_isbios%]/@name" >_temp\index.1

del _temp\temp.1
for /f "delims=" %%g in (_temp\index.1) do (
	%_xidel% -s _temp\temp.2 -e "extract( $raw, '^%%g\t.+$', 0, 'm*')" >>_temp\temp.1
) 

%_xidel% -s _temp\temp.dat -e "//%_tag%[%_isbios%]/(@name|description)" >_temp\temp.2
...
:list_chd
cls&echo Building gamelist...
%_xidel% -s _temp\temp.dat -e "//%_tag%[disk]/(@name|description)" >_temp\temp.1
...
%_xidel% -s _temp\temp.dat -e "//%_tag%/driver[@status='preliminary' or @status='protection' or @graphic='preliminary' or @color='preliminary' or @sound='preliminary']/../(@name|description)" >_temp\temp.1
%_xidel% -s _temp\temp.dat -e "//%_tag%/driver[@color='imperfect' or @sound='imperfect' or @graphic='imperfect']/../(@name|description)" >_temp\temp.2
%_xidel% -s _temp\temp.dat -e "//%_tag%/driver[@status='good' and @color='good' and @sound='good' and @graphic='good']/../(@name|description)" >_temp\temp.3

)else (
REM //overall status
%_xidel% -s _temp\temp.dat -e "//%_tag%/driver[@status='preliminary']/../(@name|description)" >_temp\temp.1
%_xidel% -s _temp\temp.dat -e "//%_tag%/driver[@status='imperfect']/../(@name|description)" >_temp\temp.2
%_xidel% -s _temp\temp.dat -e "//%_tag%/driver[@status='good']/../(@name|description)" >_temp\temp.3
...
%_xidel% -s _temp\temp.3 -e "replace( $raw, '^(\w+)\r\n(.+?)$', '$1	Good	$2', 'm')" >>_temp\status.lst

%_xidel% -s _temp\status.lst -e "replace( $raw, '^(\w+)\t(\w+)\t', '$2	$1|', 'm')" >_temp\temp.1
...
%_xidel% -s _temp\temp.dat -e "//%_tag%[%_sourcefile%@cloneof%_device%]/(@name|@cloneof|description)" >_temp\temp.1
%_xidel% -s _temp\temp.1 -e "replace( $raw, '^(\w+)\r\n(\w+)\r\n(.+?)$', '$2	$1	$3', 'm')" >_temp\temp.3

if %_choice% equ 1 (
%_xidel% -s _temp\temp.dat -e "//%_tag%[%_sourcefile%not(@cloneof)%_device%]/(@name|description)" >_temp\temp.2
...
%_xidel% -s _temp\temp.dat -e "//%_tag%[%_sourcefile%not(@cloneof)%_device%]/(@name|description)" >_temp\temp.1
...
%_xidel% -s _temp\temp.dat -e "//%_tag%%_device2%/(@name|description)" >_temp\temp.1
...
:list_src
cls&echo Building gamelist...
%_xidel% -s _temp\temp.dat -e "//%_tag%[@sourcefile%_device%]/(@sourcefile|@name|description)" >_temp\temp.1
%_xidel% -s _temp\temp.1 -e "replace( $raw, '^(\w+)\r\n([\w./]+)\r\n(.+?)$', '$2	$1	$3', 'm')" >_temp\temp.2
sort _temp\temp.2 /o "output\%_file%_gamelist_sourcefile.txt"

REM //single list
cls&echo This may take a while...
%_xidel% -s _temp\temp.dat -e "//%_tag%[@sourcefile%_device%]/@sourcefile" >_temp\temp.1
...
set /p "_ext=Enter image extension: " || set _ext=png

set "_option="
choice /m "Use only parents?"
if %errorlevel% equ 1 set "_option=[not(@cloneof)]"
cls&echo Building game list...
%_xidel% -s _temp\temp.dat -e "//%_tag%%_option%/@name" >_temp\temp.1
%_xidel% -s _temp\temp.1 -e "replace( $raw, '^(\w+)$', '$1	$1', 'm')" >_temp\copy_png.lst
call :make_batch_img copy_png.lst %_ext%
del _temp\temp.1
goto :batch_menu
...
%_xidel% -s _temp\temp.dat -e "//%_tag%[@romof='%_option%']/@name" >_temp\%_option%.lst
...
%_xidel% -s _temp\temp.dat -e "//%_tag%[disk]/@name" >_temp\chd_games.lst
...
%_xidel% -s _temp\temp.dat -e "//%_tag%[@isdevice='yes']/@name" >_temp\1_device.lst
%_xidel% -s _temp\temp.dat -e "//%_tag%[@ismechanical='yes']/@name" >_temp\2_mechanical.lst
%_xidel% -s _temp\temp.dat -e "//%_tag%[%_isbios%]/@name" >_temp\3_bios.lst

REM //include @sourcefile to seperate from standalone samples
%_xidel% -s _temp\temp.dat -e "//%_tag%[%_sourcefile%@cloneof and not(%_isbios%) and not(@isdevice) and not(@ismechanical)]/@name" >_temp\4_clones.lst
%_xidel% -s _temp\temp.dat -e "//%_tag%[%_sourcefile%not(@cloneof) and not(%_isbios%) and not(@isdevice) and not(@ismechanical)]/@name" >_temp\5_parents.lst
...
REM //no overall status
if %_drv_old%==true (
%_xidel% -s _temp\temp.dat -e "//%_tag%/driver[@status='preliminary' or @status='protection' or @graphic='preliminary' or @color='preliminary' or @sound='preliminary']/../@name" >_temp\1_preliminary.lst
%_xidel% -s _temp\temp.dat -e "//%_tag%/driver[@color='imperfect' or @sound='imperfect' or @graphic='imperfect']/../@name" >_temp\2_imperfect.lst
%_xidel% -s _temp\temp.dat -e "//%_tag%/driver[@status='good' and @color='good' and @sound='good' and @graphic='good']/../@name" >_temp\3_good.lst

)else (
REM //with overall status
%_xidel% -s _temp\temp.dat -e "//%_tag%/driver[@status='preliminary']/../@name" >_temp\1_preliminary.lst
%_xidel% -s _temp\temp.dat -e "//%_tag%/driver[@status='imperfect']/../@name" >_temp\2_imperfect.lst
%_xidel% -s _temp\temp.dat -e "//%_tag%/driver[@status='good']/../@name" >_temp\3_good.lst
...
for /f "delims=" %%g in ('%_xidel% -s _temp\temp.dat -e "matches( $raw, ' sourcefile=\""%_option%\""')"') do (
	if "%%g"=="false" (
		echo That sourcefile was not found...&timeout 3 >nul
		goto :batch_src
	)
)
for /f "delims=" %%g in ('%_xidel% -s -e "replace( '%_option%', '[&*\\/. ]', '')"') do set "_folder=%%g"

REM //get parents then add the clones??
%_xidel% -s _temp\temp.dat -e "//%_tag%[@sourcefile='%_option%']/@name" >"_temp\%_folder%.lst"
...
for /f "delims=" %%g in ('%_xidel% -s --input-format=html --output-format=cmd "%_catver%" 
...
if %_cat%==true (
	...
	if %_ver%==true (
		...
		%_xidel% -s --input-format=html "%_catver%" -e "extract( $raw, '^\[VerAdded\](.+)', 1, 'mis')" >_temp\version.tmp
		%_xidel% -s --input-format=html "%_catver%" -e "extract( $raw, '^\[Category\](.+?)^\[VerAdded\]', 1, 'mis')" >_temp\catver.tmp
	)else (
		%_xidel% -s --input-format=html "%_catver%" -e "extract( $raw, '^\[Category\](.+)', 1, 'mis')" >_temp\catver.tmp
	)
...
if %_nplay%==true (
	...
	%_xidel% -s --input-format=html "%_catver%" -e "extract( $raw, '^\[NPlayers\](.+)', 1, 'mis')" >_temp\catver.tmp
...
for /f "tokens=1,2 delims=	" %%g in (_temp\temp.2) do (
	for /f "delims=" %%i in ('%_xidel% -s _temp\catver.tmp -e "extract( $raw, '^%%g=(.+)$', 1, 'm')"') do (
...
:catver_list
cls&echo Building list...
%_xidel% -s _temp\catver.tmp -e "extract( $raw, '^\w+=(.+)$', 1, 'm*')" >_temp\temp.1
...
set "_option=%_option:'=''''%"
for /f "delims=" %%g in ('%_xidel% -s -e "replace( '%_option%', '([*\\)(.])', '\\$1')"') do set "_option=%%g"

for /f "delims=" %%g in ('%_xidel% -s _temp\catver.tmp -e "matches( $raw, '^\w+=.*?%_option%.*$', 'mi')"') do (
	if "%%g"=="false" (
...
set /a _count+=1
for /f "delims=" %%g in ('%_xidel% -s -e "replace( '%_option%', '[&*\\/. ]', '')"') do set "_folder=%%g"
%_xidel% -s _temp\catver.tmp -e "extract( $raw, '^(\w+)=.*?%_option%.*$', 1, 'mi*')" >"_temp\%_count%_%_folder%.lst"
...
echo:
if "%_option%"=="1" (
	%_xidel% -s _temp\found.tmp -e "extract( $raw, '^(\w+)=.+$', 1, 'm*')" >_temp\catver.lst
...
%_xidel% -s _temp\catver.tmp -e "extract( $raw, '^(\w+)=.*?%_option%.*$', 0, 'mi*')" >>_temp\found.tmp
...
%_xidel% -s _temp\mamediff.out -e "extract( $raw, '^\w+\t\w+$', 0, 'm*')" >_temp\images.lst

call :make_batch_img images.lst %_ext%
...
%_xidel% -s _temp\mamediff.out -e "extract( $raw, '^(\w+)\t\w+$', 1, 'm*')" >_temp\shared.lst
...
%_xidel% -s _temp\temp1.dat -e "//game/(@name|description)" >_temp\temp.1
%_xidel% -s _temp\temp.1 -e "replace( $raw, '^(\w+)\r\n(.+)$', '$1|$2', 'm')" >_temp\titles1.lst

%_xidel% -s _temp\temp2.dat -e "//game/(@name|description)" >_temp\temp.1
%_xidel% -s _temp\temp.1 -e "replace( $raw, '^(\w+)\r\n(.+)$', '$1|$2', 'm')" >_temp\titles2.lst

%_xidel% -s _temp\mamediff.out -e "extract( $raw, '^\w+\t\w+$', 0, 'm*')" >_temp\index.1
%_xidel% -s _temp\mamediff.out -e "extract( $raw, '^(\w+)\t$', 1, 'm*')" >_temp\index.2

REM //both
type nul>_temp\temp.1
for /f "tokens=1,2 delims=	" %%g in (_temp\index.1) do (
	echo %%g %%h
	%_xidel% -s _temp\titles1.lst -e "extract( $raw, '^%%g\|.+$', 0, 'm')" >>_temp\temp.1
	%_xidel% -s _temp\titles2.lst -e "extract( $raw, '^%%h\|.+$', 0, 'm')" >>_temp\temp.1

)
(echo "%_file1%" -----^> "%_file2%") >_temp\cross.txt
%_xidel% -s _temp\temp.1 -e "replace( $raw, '^(.+?)\r\n(.+)$', '$1 -----> $2', 'm')" >>_temp\cross.txt
...
for /f "tokens=1 delims=	" %%g in (_temp\%1) do (
	for /f "delims=" %%h in ('%_xidel% -s _temp\nodups.1 -e "matches( $raw, '^%%g\t.+$', 'm')"') do (
		if "%%h"=="false" %_xidel% -s _temp\%1 -e "extract( $raw, '^%%g\t.+$', 0, 'm')" >>_temp\nodups.1
	)
)
...
(
	...
	echo echo=====================================================
	echo echo This script will COPY matched .%2 and rename them   
	echo echo=====================================================
	...
	for /f "tokens=1,2 delims=	" %%h in (_temp\%1) do (	
			echo copy /y "%%h.%2" "_RENAMED\%%i.%2" ^>nul
	)
...
%_xidel% -s %1 -e "replace( $raw, '^<!DOCTYPE mame \[.+?\]>$', '', 'ms')" >_temp\temp.dat

for /f "delims=" %%g in ('%_xidel% -s --output-format=cmd _temp\temp.dat 
...
%_xidel% -s _temp\temp.dat -e "//%_tag%[@cloneof]/(@name|@cloneof)" >_temp\temp.1
%_xidel% -s _temp\temp.1 -e "replace( $raw, '^(\w+)\r\n(\w+)$', '$1=$2', 'm')" >_temp\cloneof.1
del _temp\temp.1

REM //bios plain list
%_xidel% -s _temp\temp.dat -e "//%_tag%[%_isbios%]/@name" >_temp\bios.1
...
REM %_xidel% -s _temp\temp.dat -e "replace( $raw, '^\t\t<device_ref name=\""\w+\""/>\r\n', '', 'm')" >_temp\temp.1
REM %_xidel% -s _temp\temp.1 -e "replace( $raw, '^\t<machine name=\""\w+\"" sourcefile=\""[\w./-]+\"" isdevice=\""yes\"".+?</machine>\r\n', '', 'ms')" >_temp\temp.dat
...
%_xidel% -s "%~1" -e "//game[@cloneof]/(@name|@cloneof)" >_temp\temp.1
%_xidel% -s _temp\temp.1 -e "replace( $raw, '^(\w+)\r\n(\w+)$', '$1=$2', 'm')" >_temp\cloneof.1
del _temp\temp.1
exit /b
